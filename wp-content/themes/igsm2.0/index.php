...
<?php if (is_front_page() && function_exists('d13slideshow')) {
    d13slideshow();
    echo "<br />";
} ?>
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	<div <?php post_class(); ?>>
		...
		<div class="entrybody">
			...
			<?php if (! is_page() && is_single()) { if (function_exists('related_posts')) { related_posts(); echo "<br />"; }} ?>
			<?php if (is_single()) { the_tags('Tags: ', ', ', '<br/><br/>'); } ?>
		</div> <!-- [entrybody] -->
