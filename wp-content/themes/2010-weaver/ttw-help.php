...
?>
    ...
    <p style="text-align:center;"><img src="<?php echo $tdir;?>/images/ttw-options.png" /></p>
...
?>
    ...
    <h3>Snippets</h3>
     <iframe id="previewsnip" name="previewsnip" src="<?php echo $tdir;?>/snippets.html?tempreview=true" style="width:100%;height:600px;border: 0px"></iframe>
    <?php
}

function ttw_csshelp_admin() {
    /* admin tab csshelp */
    $tdir = get_template_directory_uri();
?>

    <h3>CSS Help</h3>
     <iframe id="previewcss" name="previewcss" src="<?php echo $tdir;?>/css-help.html?tempreview=true" style="width:100%;height:600px;border: 0px"></iframe>
    <?php
}
